...
BEGIN
    ...
    FOR r IN (
        ...
        AND policyname IN (
            'avatar_images_public_access',
            'avatar_images_user_upload', 
            'avatar_images_user_update',
            'avatar_images_user_delete',
            'property_images_public_access',
            'property_images_landlord_upload',
            'property_images_owner_update',
            'property_images_owner_delete'
        )
    )
    LOOP
