/*
  # Complete NyumbaTZ Database Schema
  
  This migration creates the complete database schema for the rental platform
  including all tables, policies, functions, and initial setup.
  
  1. New Tables
    - `profiles` - User profiles with role-based access (tenant/landlord)
    - `properties` - Property listings with comprehensive details
    - `property_inquiries` - Contact inquiries from tenants to landlords
